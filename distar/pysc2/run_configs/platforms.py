...
from distar.pysc2.lib import sc_process
from distar.pysc2.run_configs import lib
...
VERSIONS = {ver.game_version: ver for ver in [
    ...
    lib.Version("5.0.0", 80949, "9AE39C332883B8BF6AA190286183ED72", None),
    lib.Version("5.0.1", 81009, "0D28678BC32E7F67A238F19CD3E0A2CE", None),
    lib.Version("5.0.2", 81102, "DC0A1182FB4ABBE8E29E3EC13CF46F68", None),
    lib.Version("5.0.3", 81433, "5FD8D4B6B52723B44862DF29F232CF31", None),
    lib.Version("5.0.4", 82457, "D2707E265785612D12B381AF6ED9DBF4", None),
    lib.Version("5.0.5", 82893, "D795328C01B8A711947CC62AA9750445", None),
    lib.Version("5.0.6", 83830, "B4745D6A4F982A3143C183D8ACB6C3E3", None),
    lib.Version("5.0.7", 84643, "A389D1F7DF9DD792FBE980533B7119FF", None),
    lib.Version("5.0.8", 86383, "22EAC562CD0C6A31FB2C2C21E3AA3680", None),
    lib.Version("5.0.9", 87702, "F799E093428D419FD634CCE9B925218C", None),
]}
...
class LocalBase(lib.RunConfig):
    ...
    def get_versions(self, containing=None):
        ...
        # versions newer than what are known by distar.ctools.pysc2, and so is the default.
